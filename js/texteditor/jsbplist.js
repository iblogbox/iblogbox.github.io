...
var parseFile = exports.parseFile = function (fileNameOrBuffer, callback) {
  ...
  var buffer = new Buffer(fileNameOrBuffer, "binary");
  return tryParseBuffer(buffer);
/*
...
},{"big-integer":6,"buffer":3,"fs":1}],6:[function(require,module,exports){
