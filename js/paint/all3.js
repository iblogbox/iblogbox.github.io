...
this.type&&this.$menu.hide();this.$menu.append(this.$menuHolder.append(this.$menuHandle));this.reset();this.setAlignment(this.options.alignment);this.wPaint.$el.append(this.$menu);a=this.$menu.css("left");this.$menu.css("left",-1E4);this.$menu.width(this.$menu.width());this.$menu.css("left",a);"secondary"===this.type&&("horizontal"===this.options.alignment?this.dockOffset.top=this.wPaint.menus.primary.$menu.outerHeight(!0):this.dockOffset.left=this.wPaint.menus.primary.$menu.outerWidth(!0))},reset:function(){var a,
