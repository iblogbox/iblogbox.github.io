        ...
        init: function (editor) {
            ...
            editor.on('mode', function () {
                ...
                if (editor.mode === 'source') {
					//edit
					var aa=editor.getCommand('autoCompleteToggle');
                    if(aa) aa.setState(window["codemirror_" + editor.id].config.autoCloseTags ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF);
