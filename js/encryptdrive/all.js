...
Aes.Ctr.encrypt = function(plaintext, password, nBits) {
  ...
  ciphertext = Base64Ex.encode(ciphertext);  // encode in base64
...
Aes.Ctr.decrypt = function(ciphertext, password, nBits) {
  var blockSize = 16;  // block size fixed at 16 bytes / 128 bits (Nb=4) for AES
  if (!(nBits==128 || nBits==192 || nBits==256)) return '';  // standard allows 128/192/256 bit keys
  ciphertext = Base64Ex.decode(ciphertext);
  password = Utf8.encode(password);
  //var t = new Date();  // timer
...
var Base64Ex = {};  // Base64 namespace

Base64Ex.code = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
 ...
 */ 
Base64Ex.encode = function(str, utf8encode) {  // http://tools.ietf.org/html/rfc4648
  utf8encode =  (typeof utf8encode == 'undefined') ? false : utf8encode;
  var o1, o2, o3, bits, h1, h2, h3, h4, e=[], pad = '', c, plain, coded;
  var b64 = Base64Ex.code;
 ...
 */ 
Base64Ex.decode = function(str, utf8decode) {
